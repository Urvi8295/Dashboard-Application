...
export default function MonthlyTarget() {
  ...
  return (
    <div className="rounded-2xl flex-grow border border-gray-200 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="rounded-2xl px-5 pt-5 bg-white shadow-default pb-6 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-0.5 font-normal text-gray-500 text-theme-sm dark:text-gray-400 text-xs">
        ...
        <div className="relative mt-4">
          ...
          <span className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-green-200 px-3 py-1 text-xs font-medium text-green-900 dark:bg-green-500/15 dark:text-green-500">
            +10%
          </span>
        </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-5 sm:py-5">
        <div>
